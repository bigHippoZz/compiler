...
function convertQueryDeclarationToMetadata(
	...
	return {
		...
		predicate: Array.isArray(declaration.predicate)
...
function convertDeclareComponentFacadeToMetadata(
	...
	const { template, interpolation } = parseJitTemplate(
		...
		declaration.type.name,
		sourceMapUrl,
		declaration.preserveWhitespaces ?? false,
	...
	return {
		...
		viewProviders:
			declaration.viewProviders !== undefined
				? new WrappedNodeExpr(declaration.viewProviders)
				: null,
		animations:
			declaration.animations !== undefined
				? new WrappedNodeExpr(declaration.animations)
				: null,
...
function convertUsedPipesToMetadata(
...
export function publishFacade(global: any) {
	...
	return (ng.ɵcompilerFacade = new CompilerFacadeImpl());
}
